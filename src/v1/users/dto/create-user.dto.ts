...
export class CreateUserDto {
  @ApiProperty({ description: 'The unique name/username of the user', example: 'john_doe' })
  @IsString()
  @IsNotEmpty({ message: 'Name/Username is required' })
  name!: string;

  @ApiProperty({ enum: LoginType, description: 'Type of login mechanism', example: LoginType.EMAIL })
  ...
  @ApiPropertyOptional({ description: 'User email (Required for EMAIL login type)', example: 'user@example.com' })
  ...
  @ApiPropertyOptional({ description: 'User password (Required for EMAIL login type)', example: 'password123' })
  @ValidateIf((o) => o.loginType === LoginType.EMAIL)
  @IsString()
  ...
  @ApiPropertyOptional({ description: 'User phone number (Required for PHONE_NUMBER login type)', example: '+1234567890' })
  ...
  @ApiPropertyOptional({ description: 'Google Account ID (Required for GOOGLE login type)', example: 'google-oauth-id-123' })
  ...
  @ApiPropertyOptional({ description: 'Apple ID (Required for APPLE login type)', example: 'apple-id-123' })
  ...
  @ApiPropertyOptional({ description: 'Facebook ID (Required for FACEBOOK login type)', example: 'facebook-id-123' })
  ...
  @ApiPropertyOptional({ description: 'Telegram chat ID (Required for TELEGRAM login type)', example: '123456789' })
  @ValidateIf((o) => o.loginType === LoginType.TELEGRAM)
  @IsString()
  @IsNotEmpty({ message: 'Telegram chat ID is required' })
  telegramChatId?: string;

  @ApiPropertyOptional({ description: 'Telegram username (Required for TELEGRAM login type)', example: 'john_telegram' })
  @ValidateIf((o) => o.loginType === LoginType.TELEGRAM)
  @IsString()
  ...
  @ApiPropertyOptional({ enum: UserRole, description: 'System role assigned to the user', default: UserRole.DEVELOPER })
  @IsOptional()
